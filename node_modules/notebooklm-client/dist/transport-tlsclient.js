...
export class TlsClientTransport {
    session;
    profile;
    onSessionExpired;
    moduleClient = null;
    ...
    async init() {
        ...
        if (!mod)
            throw new Error('tlsclientwrapper not installed. Run: npm install tlsclientwrapper');
    ...
    async execute(req) {
        if (!this.sessionClient)
            throw new SessionError('TlsClient transport not initialized');
        const doCall = async () => {
...
//# sourceMappingURL=transport-tlsclient.js.map