...
export class BrowserTransport {
    ...
    async init() {
        ...
        }, { timeout: 180000, polling: 2000 }).then(() => true).catch(() => false);
        if (!gotTokens) {
    ...
    async execute(req) {
        if (!this.page || !this.session)
            throw new SessionError('Browser transport not initialized');
        return this.page.evaluate(async (params) => {
    ...
    async extractSessionData() {
        if (!this.page)
            throw new SessionError('Not connected');
